...
export default function FuzzingLandingPage() {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-slate-950 text-white font-sans selection:bg-blue-500/30">
      ...
      {/* How It Works */}
      <section className="w-full px-6 md:px-24 py-20 relative bg-slate-950">
        <Reveal width="100%">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
              ...
              <div className="relative flex flex-col items-center text-center group">
                <div className="w-24 h-24 rounded-2xl border border-slate-800 flex items-center justify-center mb-6 shadow-xl group-hover:border-blue-500/50 group-hover:shadow-[0_0_30px_rgba(59,130,246,0.2)] transition-all duration-300">
              ...
              {/* Step 2 */}
              <div className="relative flex flex-col items-center text-center group">
                <div className="w-24 h-24 rounded-2xl border border-slate-800 flex items-center justify-center mb-6 shadow-xl group-hover:border-cyan-500/50 group-hover:shadow-[0_0_30px_rgba(6,182,212,0.2)] transition-all duration-300">
      ...
      {/* Why Fuzzing Matters */}
      <section className="w-full px-6 md:px-24 pt-12 pb-24 bg-slate-900 relative z-10">
        <Reveal width="100%">
      ...
      {/* Recent Jobs Section */}
      <section className="w-full px-6 md:px-24 py-16 bg-slate-850 border-b border-slate-800/50">
        <Reveal width="100%">
          <div className="max-w-7xl mx-auto">
            <RecentFuzzingStats />
          </div>
      ...
      <section className="w-full border-y border-slate-800/60 bg-slate-800/30 backdrop-blur-md">
        <Reveal width="100%">
